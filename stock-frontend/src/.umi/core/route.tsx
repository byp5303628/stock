...
export async function getRoutes() {
  const routes = {"1":{"path":"/welcome","name":"welcome","icon":"smile","parentId":"ant-design-pro-layout","id":"1"},"2":{"path":"/strategy","name":"策略","icon":"bulb","parentId":"ant-design-pro-layout","id":"2"},"3":{"path":"/strategy","redirect":"/strategy-list","parentId":"2","id":"3"},"4":{"name":"策略列表","path":"/strategy/strategy-list","parentId":"2","id":"4"},"5":{"path":"/strategy/strategy-list/strategy-detail","parentId":"2","id":"5"},"6":{"path":"/strategy/strategy-list/strategy-detail/stock-strategy-detail","parentId":"2","id":"6"},"7":{"path":"/operation","name":"运营工具","icon":"tool","parentId":"ant-design-pro-layout","id":"7"},"8":{"path":"/operation","redirect":"/operation/schedule-config-list","parentId":"7","id":"8"},"9":{"path":"/operation/schedule-config-list","name":"调度配置","parentId":"7","id":"9"},"10":{"path":"/operation/metadata-model-list","name":"元数据模型","parentId":"7","id":"10"},"11":{"path":"/operation/metadata-model-list/model-detail","parentId":"7","id":"11"},"12":{"path":"/operation/metadata-enum-list","name":"枚举管理","parentId":"7","id":"12"},"13":{"path":"/","redirect":"/welcome","parentId":"ant-design-pro-layout","id":"13"},"14":{"path":"*","layout":false,"id":"14"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true},"umi/plugin/openapi":{"path":"/umi/plugin/openapi","id":"umi/plugin/openapi"}} as const;
  return {
    routes,
    routeComponents: {
...
'10': React.lazy(() => import(/* webpackChunkName: "p__Metadata__ModelList__index" */'@/pages/Metadata/ModelList/index.jsx')),
'11': React.lazy(() => import(/* webpackChunkName: "p__Metadata__ModelDetail__index" */'@/pages/Metadata/ModelDetail/index.jsx')),
'12': React.lazy(() => import(/* webpackChunkName: "p__Metadata__EnumManager__index" */'@/pages/Metadata/EnumManager/index.jsx')),
'13': React.lazy(() => import('./EmptyRoute')),
'14': React.lazy(() => import(/* webpackChunkName: "p__404" */'@/pages/404.jsx')),
