...
// plugins
export { Access, useAccess, useAccessMarkedRoutes } from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-access';
export { addLocale, setLocale, getLocale, getIntl, useIntl, injectIntl, formatMessage, FormattedMessage, getAllLocales, FormattedDate, FormattedDateParts, FormattedDisplayName, FormattedHTMLMessage, FormattedList, FormattedNumber, FormattedNumberParts, FormattedPlural, FormattedRelativeTime, FormattedTime, FormattedTimeParts, IntlProvider, RawIntlProvider, SelectLang } from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-locale';
export { Provider, useModel } from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-model';
export { useRequest, UseRequestProvider, request, getRequestInstance } from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-request';
// plugins types.d.ts
export * from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-access/types.d';
export * from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-antd/types.d';
export * from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-layout/types.d';
export * from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi/plugin-request/types.d';
// @umijs/renderer-*
