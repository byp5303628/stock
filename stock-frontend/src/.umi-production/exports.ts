...
// plugins
export { Access, useAccess, useAccessMarkedRoutes } from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi-production/plugin-access';
...
export { Provider, useModel } from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi-production/plugin-model';
export { useRequest, UseRequestProvider, request, getRequestInstance } from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi-production/plugin-request';
// plugins types.d.ts
export * from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi-production/plugin-access/types.d';
export * from '/Users/baiyunpeng04/workspace/stock/stock-frontend/src/.umi-production/plugin-antd/types.d';
